...
public class SecurityFilter implements Filter {
    ...
    public void doFilter(ServletRequest _request, ServletResponse _response, FilterChain _filterChain)
        ...
        thisLogLine++;
        System.out.println(thisName + " " + thisLogLine + " " + request_l.getContextPath() + " | " + request_l.getServletPath());
        ...
        thisLogLine++;
        System.out.println(thisName + " " + thisLogLine + " Информация пользователя сохранена в Session (После успешного входа в систему).");
        User loginedUser_l = AppUtils.getLoginedUser(request_l.getSession());
        thisLogLine++;
        System.out.println(thisName + " " + thisLogLine + " User successfully logined:" + (loginedUser_l != null));
        thisLogLine++;
        System.out.println(thisName + " " + thisLogLine + " Страницы требующие входа в систему.");
        if (SecurityUtils.isSecurityPage(request_l)) {
            ...
            if (loginedUser_l == null) {
                ...
                thisLogLine++;
                System.out.println(thisName + " " + thisLogLine + " " + requestUri);
                ...
                thisLogLine++;
                System.out.println(thisName + " " + thisLogLine + request_l.getContextPath() +
            ...
            if (!hasPermission) {
                thisLogLine++;
                System.out.println(thisName + " " + thisLogLine);
                RequestDispatcher dispatcher = request_l.getServletContext().getRequestDispatcher("/accessDenied.jsp");
                thisLogLine++;
                System.out.println(thisName + " " + thisLogLine);
        ...
        thisLogLine++;
        System.out.println(thisName + " " + thisLogLine + " Не требуется вход в систему.");
        _filterChain.doFilter(request_l, response_l);
    }
}
